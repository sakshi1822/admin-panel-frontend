      ...
      <div className="card-body">
        ...
        <form onSubmit={onSubmitHandler}>
          ...
          <div className="mb-3">
            ...
            <textarea placeholder="Write Description here..." className="form-control" rows="5" id="description" required name='description' onChange={onChangeHandler} value={data.description} />
          </div>
          <div className="mb-3">
